...
python collection_mean_sd.py -f  replicate2/$out/${m}_r2_memprop_dt.txt -o $out -op  replicate2/$out/${m}_r2_order_dopc.txt  -av 3

python collection_mean_sd.py -f  replicate2/$out/${m}_r2_memprop_dt.txt   -o $out -op  replicate2/$out/${m}_r2_order_popi.txt  -av 3
